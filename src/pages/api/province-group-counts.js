...
export default async function handler(req, res) {
    let pool; // ประกาศตัวแปร pool ในระดับ global ของฟังก์ชัน
    ...
    try {
        ...
        const query = `
            ...
            SELECT 
                p.MEMBER_GROUP_NAME AS Province_GROUP_NAME,
            ...
            LEFT OUTER JOIN 
                dbo.Q_MEMBER_PROVINCE_RIGHT_FTI AS p 
            ...
            SELECT 
                N'รวมทั้งหมด' AS Province_GROUP_NAME,
                ISNULL(SUM(CASE 
